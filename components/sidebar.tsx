  ...
  return (
    <>
      ...
      <aside
        ref={sidebarRef}
        className={cn(
          "fixed top-0 left-0 h-full w-64 px-4 pb-4 flex flex-col bg-[#ECD5F1] dark:bg-[#140E12] transition-transform duration-150 ease-in-out z-50 lg:bg-transparent dark:lg:bg-transparent",
