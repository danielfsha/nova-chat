...
const MarkdownRenderer: React.FC<MarkdownRendererProps> = ({ content }) => {
  ...
  const renderer: Partial<ReactRenderer> = {
    ...
    heading(children, level) {
      const headingLevel = Math.min(Math.max(Number(level), 1), 6);
  ...
  return (
    <div className="mt-3 markdown-body prose prose-neutral dark:prose-invert max-w-none dark:text-neutral-200">
